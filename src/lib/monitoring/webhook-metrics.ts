...
export function getMetricsSummary(): {
  ...
  return {
    sandbox: {
      ...
      successRate:
        sandboxTotal > 0 ? Math.round((sandboxSuccess / sandboxTotal) * 10000) / 100 : 100,
    ...
    production: {
      ...
      successRate:
        productionTotal > 0 ? Math.round((productionSuccess / productionTotal) * 10000) / 100 : 100,
      avgDuration: productionAvgDuration,
    },
    overall: {
      total: overallTotal,
      successRate:
        overallTotal > 0 ? Math.round((overallSuccess / overallTotal) * 10000) / 100 : 100,
