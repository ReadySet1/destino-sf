...
export async function createCheckoutLink(
  params: SquareCheckoutLinkParams
  ...
  try {
    ...
    const isProduction =
      process.env.NODE_ENV === 'production' && !useSandbox && !useTransactionSandbox;
 ...
 */
export function formatCateringItemsForSquare(
  items: Array<{
    name: string;
    quantity: number;
    pricePerUnit: number;
