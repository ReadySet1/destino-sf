          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-600">
                {orderData.type === 'catering' ? 'Catering Order' : 'Regular Order'} • Placed {formatDistance(new Date(orderData.createdAt), new Date(), { addSuffix: true })}
              </p>
            </div>
          </div>
        </div>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4 pt-4 border-t border-gray-200">
                  <div>
                    ...
                    <p className="text-lg font-semibold text-gray-900">{formatCurrency(orderData.total)}</p>
                  </div>
                  <div>
                  ...
                  <div className="pt-4 border-t border-gray-200 space-y-3">
                    ...
                    {orderData.fulfillmentType && orderData.fulfillmentType !== 'pickup' && (
                      <div>
                        ...
                        <p className="text-gray-900">{orderData.fulfillmentType.replace('_', ' ')}</p>
                      </div>
                    )}
                    {orderData.trackingNumber && (
                      <div className="bg-blue-50 p-4 rounded-lg">
                        ...
                        <div className="space-y-1 text-sm">
                          <p><span className="text-blue-700">Tracking Number:</span> {orderData.trackingNumber}</p>
                          {orderData.shippingCarrier && (
                            <p><span className="text-blue-700">Carrier:</span> {orderData.shippingCarrier}</p>
                          )}
            ...
            <div className="space-y-4">
             ...
             <div className="border-t border-gray-200 pt-4 mt-6">
               <div className="flex justify-between items-center">
                 ...
                 <span className="text-lg font-bold text-gray-900">{formatCurrency(orderData.total)}</span>
               </div>
             </div>
           </div>
         </CardContent>
