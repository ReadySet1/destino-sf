...
export async function GET(request: NextRequest): Promise<NextResponse> {
  const debug = {
    ...
    headers: {
      ...
      'x-square-hmacsha256-signature': request.headers.get('x-square-hmacsha256-signature') ? 'PRESENT' : 'MISSING',
      'x-square-hmacsha256-timestamp': request.headers.get('x-square-hmacsha256-timestamp') ? 'PRESENT' : 'MISSING', 
...
export async function POST(request: NextRequest): Promise<NextResponse> {
  ...
  const debug = {
    ...
    headers: {
      ...
      'x-square-hmacsha256-signature': request.headers.get('x-square-hmacsha256-signature') ? 'PRESENT' : 'MISSING',
      'x-square-hmacsha256-timestamp': request.headers.get('x-square-hmacsha256-timestamp') ? 'PRESENT' : 'MISSING',
      'x-square-hmacsha256-signature-value': request.headers.get('x-square-hmacsha256-signature')?.substring(0, 20) + '...' || 'MISSING',
      'x-square-hmacsha256-timestamp-value': request.headers.get('x-square-hmacsha256-timestamp') || 'MISSING',
    }
  };
