    ...
    <div className="container mx-auto py-6">
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm">
        <div className="mb-6">
          ...
          <p className="text-gray-500 text-sm">
            Set base weights and per-unit increments for different product categories. 
            This affects shipping cost calculations for nationwide shipping.
          </p>
        </div>
      ...
      <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
        ...
        <ul className="text-sm text-blue-800 space-y-1">
          <li>• <strong>Base Weight:</strong> Weight of the first unit including packaging</li>
          <li>• <strong>Per-Unit Weight:</strong> Additional weight for each extra unit</li>
          <li>• <strong>Total Weight = Base Weight + (Additional Units × Per-Unit Weight)</strong></li>
