...
export default async function EditCateringItemPage({ params }: EditCateringItemPageProps) {
  // Since individual catering item editing has been removed in favor of Square integration,
  ...
  return (
    <div className="container mx-auto py-8">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Individual Catering Item Editing</CardTitle>
        ...
        <CardContent>
          <Alert className="mb-6">
            ...
            <AlertDescription>
              <strong>Individual catering item editing has been removed</strong>
              <br />
