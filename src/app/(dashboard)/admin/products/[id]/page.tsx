  ...
  async function updateProduct(formData: FormData) {
    ...
    try {
      ...
      await Promise.all([
        ...
        fetch(`${cleanAppUrl}/api/revalidate?path=/admin/products/${productId}`),
      ]);
          ...
          <div className="bg-white shadow-sm rounded-xl border border-gray-200 overflow-hidden">
            ...
            <div className="px-8 py-8">
              <div>
                ...
                />
                <p className="mt-2 text-sm text-gray-500">
                  The unique identifier from Square&apos;s catalog. Used for syncing inventory and
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-3">
                      <p className="text-sm text-blue-800 leading-relaxed">
                        <strong>Note:</strong> Product variants are managed through Square
                        Dashboard. Any changes to variants should be made in Square and then synced
                        to this system using the product sync feature.
                      </p>
                    </div>
                  </div>
                </div>
