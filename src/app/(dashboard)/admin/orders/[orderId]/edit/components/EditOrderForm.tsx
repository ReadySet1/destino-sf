...
export function EditOrderForm({ initialOrder }: EditOrderFormProps) {
  ...
  const totalBeforeGratuity =
    subtotal + deliveryFee + shippingCost + calculatedTax + calculatedServiceFee;
          ...
          >
            <FormGrid cols={2}>
              ...
              <FormField label="Order Status">
                <FormSelect name="status" value={formState.status} onChange={handleChange}>
              ...
              <FormField label="Order Notes">
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-gray-500">
                    For shipping orders, the system will automatically format addresses. You can
              ...
              <FormField label="Tax Amount">
                <div className="space-y-2">
                  <FormCheckbox
                    ...
                    onChange={e =>
                      setFormState(prev => ({ ...prev, autoCalculateTax: e.target.checked }))
                    }
                  />
              ...
              <FormField label="Convenience Fee">
                <div className="space-y-2">
                  <FormCheckbox
                    ...
                    onChange={e =>
                      setFormState(prev => ({ ...prev, autoCalculateServiceFee: e.target.checked }))
                    }
                  />
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      type="button"
                      onClick={() =>
                        setFormState(prev => ({ ...prev, gratuityMode: 'percentage' }))
                      }
                      className={`px-3 py-1 text-sm rounded ${
                        formState.gratuityMode === 'percentage'
                          ? 'bg-blue-600 text-white'
                  ...
                  {formState.gratuityMode === 'percentage' && (
                    <div className="space-y-2">
                      ...
                      <div className="flex gap-2">
                        {[10, 15, 20].map(percent => (
                          <button
                            ...
                            type="button"
                            onClick={() =>
                              setFormState(prev => ({ ...prev, gratuityPercentage: percent }))
                            }
                      ...
                      <div className="text-sm text-gray-600 bg-blue-50 p-2 rounded">
                        Calculated: ${gratuityAmount.toFixed(2)} ({formState.gratuityPercentage}% of
                        ${totalBeforeGratuity.toFixed(2)})
                      </div>
                    </div>
                  )}
                </div>
