  ...
  return (
    <div className={twMerge('w-full max-w-full px-4 py-8 bg-white text-gray-900')}>
      <Head>
        ...
        <meta name="description" content="Terms of Service for Destino" />
        <link rel="icon" href="/favicon.ico" />
      </Head>

      <main className={twMerge('flex flex-col gap-8')}>
        <h1 className={twMerge('text-4xl font-extrabold mb-6 text-center')}>Terms of Services</h1>

        <div className="bg-white shadow-md rounded-lg p-6 md:p-8">
          <div className={twMerge('w-full max-w-full')}>
            <h2 className="text-xl font-semibold text-gray-800 mb-4">OVERVIEW</h2>
            <p className="mb-4">
              This website is operated by Destino. Throughout the site, the terms &quot;we&quot;,
              &quot;us&quot; and &quot;our&quot; refer to Destino. Destino offers this website,
            ...
            <p className="mb-4">
              ...
              and conditions and policies referenced herein and/or available by hyperlink. These
              Terms of Service apply to all users of the site, including without limitation users
            ...
            <p className="mb-4">
              ...
              It is your responsibility to check this page periodically for changes. Your continued
            ...
            <p className="mb-4">
              ...
              kind and without any endorsement. We shall have no liability whatsoever arising from
            ...
            <p className="mb-4">
              ...
              (1) to maintain any comments in confidence; (2) to pay compensation for any comments;
            ...
            <p className="mb-4">
              ...
              in any way affect the operation of the Service or any related website. You may not use
              a false e‑mail address, pretend to be someone other than yourself, or otherwise
            ...
            <p className="mb-4">
              ...
              and to change or update information or cancel orders if any information in the Service
              or on any related website is inaccurate at any time without prior notice (including
            ...
            <p className="mb-4">
              In no case shall Destino, our directors, officers, employees, affiliates, agents,
              ...
              service, or for any other claim related in any way to your use of the service or any
              product, including, but not limited to, any errors or omissions in any content, or any
              loss or damage of any kind incurred as a result of the use of the service or any
            ...
            <p className="mb-4">
              You agree to indemnify, defend and hold harmless Destino and our parent, subsidiaries,
              affiliates, partners, officers, directors, agents, contractors, licensors, service
              providers, subcontractors, suppliers, interns and employees, harmless from any claim
            ...
            <p className="mb-4">
              ...
              any term or provision of these Terms of Service, we also may terminate this agreement
            ...
            <p className="mb-4">
              ...
              <a href="mailto:support@destino.com" className="text-blue-600 hover:text-blue-800">
                support@destino.com
              </a>
              .
            </p>
