    ...
    <div className="space-y-6">
      ...
      <Alert>
        ...
        <AlertDescription>
          ...
          <br />
          This form manages items stored locally in your database. These items are separate from
          Square-synced products and will appear on your customer-facing catering menu.
        </AlertDescription>
      </Alert>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="e.g., Tray of Chicken Empanadas" {...field} />
                  </FormControl>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>Determines which tab this item appears under</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                    ...
                    <div className="space-y-1 leading-none">
                      <FormLabel className={!isVegetarian ? 'text-gray-400' : ''}>Vegan</FormLabel>
                      <FormDescription>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Provide a URL to an image of this item (optional). Use full URLs (https://...)
                    for external images or paths (/images/catering/...) for images in your public
                    directory. Recommended size: 800x600px or larger.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                  ...
                  <div className="space-y-1 leading-none">
                    ...
                    <FormDescription>
                      When checked, this item will be visible and available for ordering on the
                      catering menu
                    </FormDescription>
                  </div>
                </FormItem>
