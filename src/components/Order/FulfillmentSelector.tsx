  ...
  return (
    <div className="space-y-4">
      ...
      <RadioGroup
        ...
        disabled={disabled}
      >
        <Card className={`relative p-4 cursor-pointer border-2 ${selectedMethod === 'pickup' ? 'border-primary' : 'border-border'}`}>
          <RadioGroupItem
            value="pickup"
            id="pickup"
          ...
          <div className="flex flex-col items-center text-center p-2">
            ...
            <Label htmlFor="pickup" className="font-medium">Pickup</Label>
        ...
        <Card className={`relative p-4 cursor-pointer border-2 ${selectedMethod === 'delivery' ? 'border-primary' : 'border-border'}`}>
          <RadioGroupItem
            value="delivery"
            id="delivery"
            className="absolute right-4 top-4"
          ...
          <div className="flex flex-col items-center text-center p-2">
            ...
            <Label htmlFor="delivery" className="font-medium">Local Delivery</Label>
            <p className="text-sm text-muted-foreground mt-1">
              Same-day delivery in San Francisco
            </p>
            <p className="text-sm font-medium mt-2">$8.99</p>
          </div>
        </Card>

        <Card className={`relative p-4 cursor-pointer border-2 ${selectedMethod === 'shipping' ? 'border-primary' : 'border-border'}`}>
          <RadioGroupItem
            value="shipping"
            id="shipping"
            className="absolute right-4 top-4"
          ...
          <div className="flex flex-col items-center text-center p-2">
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Ship to your address nationwide
            </p>
