        ...
        <CardContent className="pt-6">
          ...
          <div className="mt-4 flex items-center gap-4 text-sm text-muted-foreground">
            ...
            {selectedProducts.size > 0 && (
              <span className="font-medium text-primary">{selectedProducts.size} selected</span>
            )}
          </div>
        </CardContent>
      </Card>
              ...
              <TableBody>
                {filteredProducts.map(product => (
                  ...
                  >
                    ...
                    <TableCell>{getAvailabilityBadge(product.currentAvailabilityState)}</TableCell>
                    <TableCell>
                ...
                >
                  {isLoading ? (
                    ...
                    <>
                      ...
                      Apply to {selectedProducts.size} Product
                      {selectedProducts.size !== 1 ? 's' : ''}
                    </>
                  )}
                </Button>
