...
export function FulfillmentSelector({
  ...
  return (
    ...
    >
      ...
      >
        <div
          className={`fulfillment-option relative flex flex-col items-start min-h-[120px] w-full space-y-2 rounded-xl border p-5 transition-all duration-200 cursor-pointer shadow-sm focus-within:ring-2 hover:shadow-md transform hover:scale-[1.02] ${
