          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
            {features.map(feature => (
              ...
              >
                ...
                {/* Aquí se aplica la clase de Dancing_Script */}
                <h3
                  className={`text-3xl font-bold tracking-tight text-slate-800 sm:text-3xl mb-4 ${dancingScript.className}`}
                >
                  {feature.title}
                </h3>
                <p
