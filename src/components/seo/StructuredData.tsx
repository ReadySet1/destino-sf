  ...
  return (
    <StructuredData
      config={{
        ...
        description: 'Experience authentic Latin flavors with our handcrafted empanadas and alfajores in San Francisco.',
  ...
  return (
    <StructuredData
      config={{
        ...
        description: 'Explore our delicious selection of handcrafted empanadas and alfajores made with traditional recipes.',
  ...
  return (
    <StructuredData
      config={{
        ...
        description: 'Elevate your event with our premium catering services featuring authentic empanadas and Latin cuisine.',
...
export function LocalBusinessStructuredData() {
  ...
  const structuredData = {
    ...
    description: 'Authentic Latin restaurant specializing in handcrafted empanadas and alfajores in San Francisco.',
    ...
    review: [
      {
        ...
        reviewBody: 'The empanadas are absolutely delicious! Authentic flavors that remind me of home. The alfajores are the perfect dessert.',
        reviewRating: {
          '@type': 'Rating',
          ratingValue: 5,
          bestRating: 5,
      ...
      },
      {
        ...
        reviewBody: 'Great catering service for our corporate event. Professional, timely, and the food was a hit with everyone.',
        reviewRating: {
          '@type': 'Rating',
          ratingValue: 5,
          bestRating: 5,
