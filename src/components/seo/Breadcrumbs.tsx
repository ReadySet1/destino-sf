...
export function Breadcrumbs({
  ...
  return (
    <>
      ...
      >
        <ol
          className="flex items-center space-x-1 text-gray-700 whitespace-nowrap"
          itemScope
        ...
        >
          {allItems.map((item, index) => (
            ...
            >
              ...
              <Link
                ...
                itemProp="item"
              >
                {index === 0 && <Home className="h-3 w-3 mr-1 flex-shrink-0" aria-hidden="true" />}
          ...
          {currentPage && (
            ...
            >
              ...
              />
              <span
                className="text-gray-900 font-semibold truncate max-w-[200px] sm:max-w-[300px]"
                itemProp="name"
              >
                {currentPage}
              </span>
