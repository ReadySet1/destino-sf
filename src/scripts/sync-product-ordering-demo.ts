...
export async function syncProductOrderingDemo(): Promise<ProductUpdateResult> {
  ...
  try {
    ...
    const dbProductsExample = [
      {
        id: 'uuid1',
        squareId: 'BAHPTM7P3HVQ6N2V5PMZMDPM',
        name: 'Alfajores de Lucuma',
        ordinal: null,
      },
      {
        id: 'uuid2',
        squareId: 'N6FQCAR5XZILI7BGUIN4NF4Q',
        name: 'Alfajores Classic',
        ordinal: null,
      },
      {
        id: 'uuid3',
        squareId: 'KZ4IKWU5JBYAFZK545ULVDFQ',
        name: 'Alfajores Chocolate',
        ordinal: null,
      },
      {
        id: 'uuid4',
        squareId: 'FK7CM63FVZUW7FA43AL3GV6K',
    ...
    const correctOrder = sortedByOrdinal.map((product, index) => `${index + 1}. ${product.name}`);
