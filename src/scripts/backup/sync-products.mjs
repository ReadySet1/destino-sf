...
// Square configuration - use production environment
const SQUARE_TOKEN = process.env.SQUARE_PRODUCTION_TOKEN || process.env.SQUARE_ACCESS_TOKEN;
const SQUARE_HOST = 'connect.squareup.com'; // Using production
