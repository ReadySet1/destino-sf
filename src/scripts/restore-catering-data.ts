...
const APPETIZER_PACKAGES = [
  {
    ...
    description: 'Choose 5 appetizer items from our signature collection. Perfect for intimate gatherings and small events. Each package includes a variety of vegetarian, vegan, and protein options to accommodate all dietary preferences.',
    minPeople: 2,
  ...
  },
  {
    ...
    description: 'Choose 7 appetizer items from our signature collection. Ideal for medium-sized gatherings and corporate events. Features our most popular items including empanadas, pintxos, and seasonal specialties.',
    minPeople: 2,
  ...
  },
  {
    ...
    description: 'Choose 9 appetizer items from our signature collection. Perfect for large events and celebrations. Includes our complete range of Latin American appetizers from traditional empanadas to modern fusion creations.',
    minPeople: 2,
  ...
  },
  {
    ...
    description: 'Our signature premium appetizer experience featuring 12 carefully curated items including seafood specialties, artisanal selections, and chef\'s favorites. Perfect for upscale events and special occasions.',
    minPeople: 6,
    pricePerPerson: 58.00,
    type: 'INDIVIDUAL',
    imageUrl: '/images/catering/premium-appetizer-package.jpg',
    dietaryOptions: ['Premium seafood options', 'Artisanal cheese selections', 'Gourmet protein options'],
    isActive: true
  }
];
...
const SHARE_PLATTERS = [
  {
    ...
    description: 'Crispy plantain chips served with our signature yellow pepper cream sauce. Perfect sharing appetizer for 10-20 guests.',
    minPeople: 10,
  ...
  },
  {
    ...
    description: 'Crispy plantain chips served with our signature yellow pepper cream sauce. Perfect sharing appetizer for 25-40 guests.',
    minPeople: 25,
    pricePerPerson: 2.00, // $80 for 40 people
    type: 'APPETIZER',
  ...
  },
  {
    ...
    description: 'Artisanal selection of local and imported cheeses and cured meats. Includes 4 varieties with accompaniments. Serves 10-20 guests.',
    minPeople: 10,
    pricePerPerson: 7.50, // $150 for 20 people
    type: 'APPETIZER',
  ...
  },
  {
    ...
    description: 'Artisanal selection of local and imported cheeses and cured meats. Includes 6 varieties with accompaniments. Serves 25-40 guests.',
    minPeople: 25,
    pricePerPerson: 7.00, // $280 for 40 people
    type: 'APPETIZER',
...
const BOXED_LUNCH_PACKAGES = [
  {
    ...
    description: 'Essential boxed lunch featuring our signature empanada, seasonal side, dessert, and beverage. Perfect for corporate meetings and casual events.',
    minPeople: 6,
  ...
  },
  {
    ...
    description: 'Enhanced boxed lunch with choice of two empanadas, artisanal sides, premium dessert, and beverage. Ideal for client meetings and special events.',
    minPeople: 6,
    pricePerPerson: 26.00,
    type: 'BOXED_LUNCH',
    imageUrl: '/images/catering/tier-2-lunch.jpg',
    dietaryOptions: ['Multiple vegetarian options', 'Vegan options available', 'Gluten-free options'],
    isActive: true
  },
  {
    name: 'Tier 3 Boxed Lunch',
    description: 'Premium boxed lunch experience with three empanadas, gourmet sides, artisanal dessert selection, and premium beverage. Perfect for VIP events.',
    minPeople: 6,
    pricePerPerson: 34.00,
    type: 'BOXED_LUNCH',
    imageUrl: '/images/catering/tier-3-lunch.jpg',
    dietaryOptions: ['Extensive vegetarian selection', 'Vegan options', 'Gluten-free options', 'Premium ingredients'],
    isActive: true
  }
];
...
const STORE_SETTINGS = {
  name: 'Destino SF',
  cateringMinimumAmount: 0.00, // No minimum for flexibility
...
async function restoreAllCateringData() {
  ...
  try {
    ...
    console.log('');
    console.log('📋 Summary:');
    console.log(`  • Packages: ${packageResults.created} created, ${packageResults.updated} updated`);
