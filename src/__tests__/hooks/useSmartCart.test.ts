...
const mockUseCateringCartStore = useCateringCartStore as jest.MockedFunction<typeof useCateringCartStore>;
const mockIsCateringProduct = cartHelpers.isCateringProduct as jest.MockedFunction<typeof cartHelpers.isCateringProduct>;
const mockSerializeDecimal = serialization.serializeDecimal as jest.MockedFunction<typeof serialization.serializeDecimal>;
