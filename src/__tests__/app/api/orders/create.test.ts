    ...
    test('should create order successfully with valid data', async () => {
      ...
      const order = await prisma.order.create({
        data: {
          ...
          status: 'PENDING',
          customerName: validOrderData.customerInfo.name,
          email: validOrderData.customerInfo.email,
          phone: validOrderData.customerInfo.phone,
          fulfillmentType: validOrderData.fulfillmentMethod,
          deliveryTime: validOrderData.deliveryTime,
          notes: validOrderData.specialInstructions,
