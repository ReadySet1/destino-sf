...
import { validateStartupDatabase, getDatabaseInfo, validateDatabaseEnvironment } from '../src/lib/db-environment-validator';
...
async function main() {
  ...
  try {
    ...
    if (!process.env.DATABASE_URL) {
      ...
      console.log('     postgresql://postgres:[PASSWORD]@db.ocusztulyiegeawqptrs.supabase.co:5432/postgres');
      ...
      console.log('     postgresql://postgres:[PASSWORD]@db.drrejylrcjbeldnzodjd.supabase.co:5432/postgres');
    } else {
