...
- [Test Database Setup](getting-started/test-database-setup.md)
...
- [E-commerce Core](features/ecommerce/README.md)
  - [Product Catalog](features/ecommerce/product-catalog.md)
...
- [Catering System](features/catering/README.md)
  ...
  - [Minimum Orders](features/catering/minimum-orders.md)
...
- [REST API](api/rest-api/README.md)
  ...
  - [Products API](api/rest-api/products.md)
...
- [E2E Testing](testing/e2e-testing/README.md)
  - [Playwright Setup](testing/e2e-testing/playwright-setup.md)
